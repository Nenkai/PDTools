...
public class Entry
{
    ...
    public List<sbyte> BoostRaceRatio { get; set; } = [];
    public List<byte> BoostRatio { get; set; } = [];
    ...
    public void Deserialize(ref BitStream reader)
    {
        ...
        if (magic != 0xE5_E5_25_EE && magic != 0xE6_E6_25_EE)
            throw new System.IO.InvalidDataException($"Course magic did not match - Got {magic:X8}, expected 0xE6E625EE");
