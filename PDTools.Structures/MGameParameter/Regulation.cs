...
namespace PDTools.Structures.MGameParameter
{
    public class Regulation
    {
        ...
        public List<CarCategoryRestriction> CarCategories { get; set; } = new List<CarCategoryRestriction>();
        public List<MCarThin> Cars { get; set; } = new List<MCarThin>();
        public List<MCarThin> BanCars { get; set; } = new List<MCarThin>();
        ...
        public List<Tuner> Tuners { get; set; } = new List<Tuner>();
        ...
        {
            CarCategories = new List<CarCategoryRestriction>();
