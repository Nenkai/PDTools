...
public class CourseMapFile
{
    ...
    public List<CourseMapFace> OffCourseFaces { get; set; } = [];
    public List<CourseMapFace> RoadFaces { get; set; } = [];
    public List<CourseMapFace> PitLaneFaces { get; set; } = [];
    public List<CourseMapFace> SectionFaces { get; set; } = [];
    public List<CourseMapFace> FullRoadLine { get; set; } = [];
