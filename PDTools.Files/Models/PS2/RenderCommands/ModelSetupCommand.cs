...
public abstract class ModelSetupPS2Command
{
    ...
    public static ModelSetupPS2Command GetByOpcode(ModelSetupPS2Opcode opcode)
    {
        ModelSetupPS2Command cmd = opcode switch
        {
            ...
            ModelSetupPS2Opcode.pglGT3_Unk40 => new Cmd_GT3_Unk40(),
            ...
            ModelSetupPS2Opcode.pglGT3_3_1ui => new Cmd_GT3_3_1ui(),
            ModelSetupPS2Opcode.pglGT3_3_4f => new Cmd_GT3_3_4f(),
            ...
            ModelSetupPS2Opcode.pglCullFace => new Cmd_pglCullFace(),
            ModelSetupPS2Opcode.Unk_65 => new Cmd_Unk65(),
            ModelSetupPS2Opcode.Unk_66 => new Cmd_Unk66(),
            ModelSetupPS2Opcode.CallVM => new Cmd_CallVM(),
            ModelSetupPS2Opcode.VM_MultMatrix => new Cmd_VM_MultMatrix(),
            ModelSetupPS2Opcode.VM_pglTranslate => new Cmd_VM_pglTranslate(),
            ModelSetupPS2Opcode.VM_pglScale => new Cmd_VM_pglScale(),
            ModelSetupPS2Opcode.VM_pglRotate => new Cmd_VM_pglRotate(),
            ModelSetupPS2Opcode.VM_pglRotateX => new Cmd_VM_pglRotateX(),
            ModelSetupPS2Opcode.VM_pglRotateY => new Cmd_VM_pglRotateY(),
            ModelSetupPS2Opcode.VM_pglRotateZ => new Cmd_VM_pglRotateZ(),
            ...
            ModelSetupPS2Opcode.pgluTexTableFromExternalTexSetUShort => new Cmd_pgluTexTableFromExternalTexSetUShort(),
