...
{
    public class Cmd_pglMultMatrix : ModelSetupPS2Command
    {
        public override ModelSetupPS2Opcode Opcode => ModelSetupPS2Opcode.pglMultMatrix;
        ...
        {
            return $"{nameof(Cmd_pglMultMatrix)}";
        }
    }
}
