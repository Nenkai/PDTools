...
public abstract class ModelSetupCommand
{
    ...
    public static ModelSetupCommand GetByOpcode(byte opcode)
    {
        ModelSetupCommand cmd = opcode switch
        {
            0 => new Command_0_End(),
            2 => new Command_2_Unk(),
            3 => new Command_3_PGLUCallShapeByte(),
            4 => new Command_4_PGLUCallShapeUShort(),
            5 => new Command_5_Switch(),
            6 => new Command_6_Unk(),
            7 => new Command_7_Unk(),
            8 => new Command_8_Unk(),
            9 => new Command_JumpByte(),
            10 => new Command_JumpShort(),
            ...
            59 => new Command_CallShape2Byte(),
            60 => new Command_CallShape2UShort(),
