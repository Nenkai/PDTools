...
{
    public List<MDL3Material> Definitions { get; set; } = [];
    public List<MDL3MaterialData> MaterialDatas { get; set; } = [];
    public List<CellGcmParams> GcmParams { get; set; } = [];
    public List<PGLUCellTextureInfo> TextureInfos { get; set; } = [];
