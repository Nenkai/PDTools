...
public class ShaderProgramEntry_0x2C_0x10
{
    ...
    public static ShaderProgramEntry_0x2C_0x10 FromStream(BinaryStream bs, long basePos)
    {
        var entry = new ShaderProgramEntry_0x2C_0x10();
