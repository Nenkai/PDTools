...
public class ShaderProgramEntry_0x2C_0x38
{
    ...
    public static ShaderProgramEntry_0x2C_0x38 FromStream(BinaryStream bs, long basePos)
    {
        var entry = new ShaderProgramEntry_0x2C_0x38();
