...
{
    public class ShaderProgramEntry_0x20_0x18
    {
        ...
        public static ShaderProgramEntry_0x20_0x18 FromStream(BinaryStream bs, long basePos)
        {
            var entry = new ShaderProgramEntry_0x20_0x18();
