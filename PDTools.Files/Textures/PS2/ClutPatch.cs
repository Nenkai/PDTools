...
/// </summary>
public class ClutPatchSet
{
    public List<TextureClutPatch> TexturesToPatch { get; set; } = [];
...
public class TextureClutPatch
{
    ...
    public override int GetHashCode()
    {
        return HashCode.Combine(CSA_ClutEntryOffset, CBP_ClutBufferBasePointer, Format, PGLUTextureIndex);
    }
}
