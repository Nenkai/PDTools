...
namespace PDTools.Crypto
{
    public static class CRC32
    {
		...
		/// <returns></returns>
		public static uint CRC32_0x04C11DB7_UInt(uint input)
		{
			uint result = 0x0;
			for (int i = 0; i < 4; i++)
			{
				...
				result = result << 0x8 ^ CRC32.checksum_0x04C11DB7[a];
			}
			return ~result;
		}
		...
		#region CRC
		public static uint[] checksum_0x04C11DB7 = {
		...
		public static uint[] checksum_0x77073096 =
        {
